...
erpnext.accounts.bank_reconciliation.MatchTab = class MatchTab {
  ...
  async get_matching_vouchers(document_types) {
    let vouchers = await frappe
      .call({
        method:
          'camt_import.camt_import.doctype.transaction_matching_tool.transaction_matching_tool.get_linked_payments',
        args: {
  ...
  bulk_reconcile_vouchers(selected_vouchers, reconcile_multi_party) {
    ...
    frappe.call({
      method:
        'camt_import.camt_import.doctype.transaction_matching_tool.transaction_matching_tool.bulk_reconcile_vouchers',
      args: {
        bank_transaction_name: this.transaction.name,
